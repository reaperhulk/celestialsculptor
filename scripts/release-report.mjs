...
const report = {
  physicalDevices: aggregateDevices(
    [],
    build.revision,
    build.assets['pkg/celestial_wasm_bg.wasm']?.sha256,
  ),
  numericalQualification:
    'Required separate 600-year CI job; see long-run-numerical-evidence artifact',
