...
const steps=[[process.execPath,['scripts/audit-design.mjs']],['cargo',['fmt','--all','--check']],['cargo',['clippy','--workspace','--all-targets','--locked','--','-D','warnings']],['cargo',['test','--workspace','--release','--locked']],[npm,['run','build']],[npm,['run','check']],[npm,['test']]];
