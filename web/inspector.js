...
export class Inspector {
 constructor(root){
  ...
  this.summary=make('p','body-summary');this.rotation=make('p','body-rotation');this.details=make('details');
  ...
  this.details.append(title,this.orbit,this.material,this.pull);root.replaceChildren(label,this.summary,this.rotation,this.details);
 }
 update(state,body){
  this.rotation.hidden=!body;this.details.hidden=!body;
