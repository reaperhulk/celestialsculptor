...
export default defineConfig({
 ...
 projects:[{name:'desktop',use:{browserName:'chromium',viewport:{width:1366,height:768}}},{name:'phone',use:{browserName:'chromium',viewport:{width:390,height:844},isMobile:true,hasTouch:true}},{name:'small-phone',use:{browserName:'chromium',viewport:{width:320,height:568},isMobile:true,hasTouch:true}},{name:'tablet',use:{browserName:'chromium',viewport:{width:1024,height:768},hasTouch:true}},{name:'laptop',use:{browserName:'chromium',viewport:{width:1280,height:720}}},{name:'large-desktop',use:{browserName:'chromium',viewport:{width:1920,height:1080}}},{name:'landscape-phone',use:{browserName:'chromium',viewport:{width:844,height:390},hasTouch:true}}],
