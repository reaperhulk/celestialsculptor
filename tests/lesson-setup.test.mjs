...
test('every lesson becomes its year-zero challenge without awarding its future result',async()=>{
 ...
 const original={replay:{version:7,config:{},end_tick:128,commands:[{tick:0,command:{}},{tick:64,command:{}}]}};assert.equal(lessonSetup(original).commands.length,1);assert.equal(original.replay.commands.length,2);
});
